                    ...
                    <div className="flex-1 overflow-y-auto p-4">
                        {items.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <Button
                                    onClick={onClose}
                                    className="gradient-yellow-orange text-amazon-dark-blue"
                                >
                                    Continue Shopping
                                </Button>
                            </div>
                            ...
                            <div className="space-y-4">
                                {items.map((item) => (
                                    <div
                                        key={item.id}
                                        className="flex gap-3 p-3 bg-amazon-light-gray rounded-lg animate-scale-in"
                                    >
                                        <img
                                            src={item.image}
                                            alt={item.title}
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-amazon-text-dark font-semibold">
                                                ${item.price}
                                            </p>
