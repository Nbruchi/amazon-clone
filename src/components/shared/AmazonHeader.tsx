...
const AmazonHeader = () => {
    ...
    return (
        <>
            <header className="bg-amazon-darker-blue text-white">
                {/* Top Navigation */}
                <div className="px-2 py-1">
                    <div className="flex items-center justify-between w-full mx-auto">
                        ...
                        <Link
                            to="/"
                            className="flex items-center hover:border hover:border-white p-1"
                        >
                        ...
                        <div className="flex-1 max-w-5xl mx-2">
                            <div className="flex rounded overflow-hidden">
                                <select className="bg-gray-200 text-black px-2 py-2 text-sm border-r-2 border-amazon-orange focus:outline-none w-auto">
                                ...
                                <Input
                                    ...
                                    className="flex-1 border-0 rounded-none focus:ring-0 focus:border-0 py-2 text-primary font-semibold text-lg"
                                />
                                <Button className="amazon-button-primary rounded-tr-md rounded-br-md px-4 py-2">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            {/* Returns & Orders */}
                            <Link
                                to="/gp/your-account/order-history"
                                className="hover:border hover:border-white p-1"
                            >
                            ...
                            <Link
                                ...
                                className="flex items-center hover:border hover:border-white p-1 relative"
                            >
                ...
                <div className="bg-amazon-dark-blue border-t border-gray-600 px-2 py-1">
                    <div className="flex items-center space-x-4 max-w-full mx-auto text-sm">
                        ...
                        <Link
                            to="/gp/goldbox"
                            className="hover:underline hover:bg-white/10 p-1 rounded"
                        >
                            Today's Deals
                        </Link>
                        <Link
                            to="/gp/css/homepage.html"
                            className="hover:underline hover:bg-white/10 p-1 rounded"
                        >
                            Customer Service
                        </Link>
                        <Link
                            to="/gp/registry/search"
                            className="hover:underline hover:bg-white/10 p-1 rounded"
                        >
                            Registry
                        </Link>
